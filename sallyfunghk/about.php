...
<section id = 'about-section'>
    <div class = 'container'>
        <div class = 'row'>
            <div class = 'offset-1 col-md-10 mx-auto'>
                ...
                <div class='about-section2'>
                    <div class='content'>
                        <div class='fadeIn'>
                            <div class='heading'>
                                <h1><b>My name is Sally, am now <?php echo (date('Y') - 1995) ?></b></h1>
                        <img src = "./images/image2.jpg"/>
                            </div> <!-- /.heading -->
                            <p>
                                I was graduated from the Hong Kong Institute of Vocational Education in 2015. Majoring in Mobile Applications Development. After graduation, I worked for an engineering company before, and I am now working for a nursing home.
                            </p>
                            <p>
                                After working for several companies, I found that it is not very meaningful to work in a career that I am not interested in. Every time I think I need to work until my retirement in a career that I am not interested in. I would be very upset. I am still willing to fight for a chance to work as a programmer. This is the reason why I am seeking a programmer job.
                            </p>
                        </div> <!-- /.fadeIn -->
                    </div> <!-- /.content -->
                    ...
                    <div class='content'>
                        <div class='fadeIn'>
                            <div class='heading'>
                                <h1><b>I like reading books</b></h1>
                            </div> <!-- /.heading -->
